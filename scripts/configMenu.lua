...
if ModConfigMenu then
	...
	ModConfigMenu.AddSetting(category, "General", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.noChapter1Nests end,
	    Display = function() return "Replace Nests in Chapter 1: " .. (IRFconfig.noChapter1Nests and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "General", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.matriarchFistula end,
	    Display = function() return "Matriarch Fistulas: " .. (IRFconfig.matriarchFistula and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.noHiddenPins end,
	    Display = function() return "Pin: " .. (IRFconfig.noHiddenPins and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.noHiddenPoly end,
	    Display = function() return "Polycephalus: " .. (IRFconfig.noHiddenPoly and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.noHiddenStain end,
	    Display = function() return "The Stain: " .. (IRFconfig.noHiddenStain and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.noHiddenDust end,
	    Display = function() return "Dust: " .. (IRFconfig.noHiddenDust and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.appearPins end,
	    Display = function() return "Pin: " .. (IRFconfig.appearPins and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.appearMomsHands end,
	    Display = function() return "Mom's Hands: " .. (IRFconfig.appearMomsHands and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.appearNeedles end,
	    Display = function() return "Needles: " .. (IRFconfig.appearNeedles and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.laserEyes end,
	    Display = function() return "Eyes: " .. (IRFconfig.laserEyes and "On" or "Off") end,
	    OnChange = function(bool)
	...
	ModConfigMenu.AddSetting(category, "Indicators", {
    	Type = ModConfigMenu.OptionType.BOOLEAN,
	    CurrentSetting = function() return IRFconfig.laserRedGhost end,
	    Display = function() return "Red Ghost: " .. (IRFconfig.laserRedGhost and "On" or "Off") end,
	    OnChange = function(bool)
